...
if __name__ == '__main__':
    ...
    treecut_filename = "treecuts_{}_multi{}.pkl".format(args.ntree, f"_{args.subsample}" if args.subsample != "all" else "")
    ...
    if args.eval_dataset != '':
        ...
        if args.eval_dataset == 'imagenet-a' or args.eval_dataset == 'imagenet-r':
            cfg['treecuts'] = Path('prepro/data', args.eval_dataset, treecut_filename)
        else:
            cfg['treecuts'] = Path('prepro/data', cfg['data']['name'], treecut_filename)
